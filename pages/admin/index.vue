...
<template>
  <div class="page-stack">
    <section class="page-heading">
      <div><p class="eyebrow">Visão geral</p><h1>Painel de controlo</h1><p class="page-heading__description">Resumo rápido do conteúdo e das mensagens do site AM Moreira.</p></div>
